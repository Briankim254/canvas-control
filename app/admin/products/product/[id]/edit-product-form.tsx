...
export function EditProductForm({ product }: { product: Product }) {
  ...
  async function onSubmit(values: z.infer<typeof ProductFormSchema>) {
    ...
    try {
      toast.promise(
        updateProductPartial(product.id, values).then((data) => {
          return data;
        }),
        {
          loading: "Loading...",
          ...
          <div className=" grid max-w-[59rem] flex-1 auto-rows-max gap-4">
            <div className="flex items-center gap-4">
              ...
              <Badge
                ...
                className={
                  product.stock > 0
                    ? `bg-green-500 ml-auto sm:ml-0`
                    : `bg-red-500 ml-auto sm:ml-0`
                }
              >
                {/* if stock count is greater than 1 then in stock otherwise out of stock */}
